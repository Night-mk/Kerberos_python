...
def tgs_create(username,IDO, IDV, Ticket_tgs,Authenticator_c):
    ...
    for i in uk_users:
        ...
        Ticket_v_body['ACc']=ac_get_permission(username,Authenticator_c_body['IDo'])
        ...
        TGS_body['lifetime4']=Ticket_v_body['lifetime4']
        ...
        #区块链上链
        #将用户申请信息发送到区块链端
        url = 'http://192.168.1.130:8090/writeticket'
        block_key ={
            'IDc':username,
            'IDo':IDO
        }
